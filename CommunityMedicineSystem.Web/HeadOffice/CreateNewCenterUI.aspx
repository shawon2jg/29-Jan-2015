...
<body>
    <form id="form1" runat="server" class="form-horizontal">
        ...
        <div class="form-group">
            <label for="inputDistrictName" class="col-sm-2 control-label">District Name</label>
            <div class="col-sm-4">
                <asp:DropDownList ID="districtDropDownList" CssClass="form-control" runat="server"></asp:DropDownList>
            </div>
        </div>
        
        <div class="form-group">
            <label for="inputThanaName" class="col-sm-2 control-label">Thana Name</label>
            <div class="col-sm-4">
                <asp:DropDownList ID="thanaDropDownList" CssClass="form-control" runat="server"></asp:DropDownList>
            </div>
        </div>
